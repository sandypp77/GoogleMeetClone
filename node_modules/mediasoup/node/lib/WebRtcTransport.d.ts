...
export declare class WebRtcTransport<WebRtcTransportAppData extends AppData = AppData> extends Transport<WebRtcTransportEvents, WebRtcTransportObserverEvents, WebRtcTransportAppData> {
    #private;
    /**
     * @private
     */
