...
export declare class PipeTransport<PipeTransportAppData extends AppData = AppData> extends Transport<PipeTransportEvents, PipeTransportObserverEvents, PipeTransportAppData> {
    #private;
    /**
     * @private
     */
