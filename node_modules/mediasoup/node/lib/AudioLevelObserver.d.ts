...
export declare class AudioLevelObserver<AudioLevelObserverAppData extends AppData = AppData> extends RtpObserver<AudioLevelObserverEvents, AudioLevelObserverAppData> {
    /**
     * @private
     */
